...
public class OceanizedHorseModel extends GeoModel<OceanizedHorseEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArborMod.MODID, "textures/entities/oceanized_horse.png");

	@Override
	public ResourceLocation getAnimationResource(OceanizedHorseEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArborMod.MODID, "animations/oceanzied_horse.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(OceanizedHorseEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArborMod.MODID, "geo/oceanzied_horse.geo.json");
	}
