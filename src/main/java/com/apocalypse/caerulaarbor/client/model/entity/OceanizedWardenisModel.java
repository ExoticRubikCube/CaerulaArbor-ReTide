...
public class OceanizedWardenisModel extends GeoModel<OceanizedWardenisEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArborMod.MODID, "textures/entities/oceanized_wardenis.png");

	@Override
	public ResourceLocation getAnimationResource(OceanizedWardenisEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArborMod.MODID, "animations/oceanized_wardenis.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(OceanizedWardenisEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArborMod.MODID, "geo/oceanized_wardenis.geo.json");
	}
