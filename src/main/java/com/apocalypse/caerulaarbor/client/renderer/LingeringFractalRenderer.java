...
import com.apocalypse.caerulaarbor.client.model.LingeringFractalModel;
...
public class LingeringFractalRenderer extends GeoEntityRenderer<LingeringFractalEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, LingeringFractalEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
