...
import com.apocalypse.caerulaarbor.client.model.entity.FlamarineStatueModel;
...
public class FlamarineStatueRenderer extends GeoEntityRenderer<FlamarineStatueEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FlamarineStatueEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
