...
import com.apocalypse.caerulaarbor.client.model.entity.IsharmlaTearModel;
import com.apocalypse.caerulaarbor.client.model.entity.layer.IsharmlaTearLayer;
...
public class IsharmlaTearRenderer extends GeoEntityRenderer<IsharmlaTearEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, IsharmlaTearEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
