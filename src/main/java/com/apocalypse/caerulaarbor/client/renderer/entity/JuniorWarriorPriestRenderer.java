...
import com.apocalypse.caerulaarbor.client.model.entity.JuniorWarriorPriestModel;
import com.apocalypse.caerulaarbor.entity.JuniorWarriorPriestEntity;
...
public class JuniorWarriorPriestRenderer extends GeoEntityRenderer<JuniorWarriorPriestEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, JuniorWarriorPriestEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
