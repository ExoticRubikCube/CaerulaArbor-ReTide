...
import com.apocalypse.caerulaarbor.client.model.item.KnightIronModel;
...
public class KnightIronArmorRenderer extends GeoArmorRenderer<KnightIronItem> {
	public KnightIronArmorRenderer() {
		super(new KnightIronModel());
	...
	@Override
	public RenderType getRenderType(KnightIronItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
