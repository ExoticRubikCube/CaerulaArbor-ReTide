...
import com.apocalypse.caerulaarbor.client.model.entity.NautilusHeadhunterModel;
import com.apocalypse.caerulaarbor.client.model.entity.layer.NautilusHeadhunterLayer;
...
public class NautilusHeadhunterRenderer extends GeoEntityRenderer<NautilusHeadhunterEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, NautilusHeadhunterEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
