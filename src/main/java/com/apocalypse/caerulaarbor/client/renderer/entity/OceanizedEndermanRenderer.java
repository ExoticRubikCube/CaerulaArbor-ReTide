...
import com.apocalypse.caerulaarbor.client.model.entity.OceanizedEndermanModel;
import com.apocalypse.caerulaarbor.client.model.entity.layer.OceanizedEndermanLayer;
...
public class OceanizedEndermanRenderer extends GeoEntityRenderer<OceanizedEndermanEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedEndermanEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
