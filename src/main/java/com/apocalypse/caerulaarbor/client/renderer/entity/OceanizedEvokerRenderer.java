...
import com.apocalypse.caerulaarbor.client.model.entity.OceanizedEvokerModel;
import com.apocalypse.caerulaarbor.client.model.entity.layer.OceanizedEvokerLayer;
...
public class OceanizedEvokerRenderer extends GeoEntityRenderer<OceanizedEvokerEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedEvokerEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
