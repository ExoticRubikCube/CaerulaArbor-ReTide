...
import com.apocalypse.caerulaarbor.client.model.entity.OceanizedFoxModel;
...
public class OceanizedFoxRenderer extends GeoEntityRenderer<OceanizedFoxEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedFoxEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
