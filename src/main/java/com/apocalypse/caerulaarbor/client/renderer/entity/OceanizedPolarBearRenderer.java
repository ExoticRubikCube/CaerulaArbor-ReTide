...
import com.apocalypse.caerulaarbor.client.model.entity.OceanizedPolarBearModel;
...
public class OceanizedPolarBearRenderer extends GeoEntityRenderer<OceanizedPolarBearEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedPolarBearEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red,
