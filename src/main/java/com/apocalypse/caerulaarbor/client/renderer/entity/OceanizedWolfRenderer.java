...
import com.apocalypse.caerulaarbor.client.model.entity.layer.OceanizedWolfLayer;
import com.apocalypse.caerulaarbor.client.model.entity.OceanizedWolfModel;
...
public class OceanizedWolfRenderer extends GeoEntityRenderer<OceanizedWolfEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedWolfEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
