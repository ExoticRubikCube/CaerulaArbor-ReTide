...
import com.apocalypse.caerulaarbor.client.model.entity.PocketSeaCreeperModel;
import com.apocalypse.caerulaarbor.client.model.entity.layer.PocketSeaCreeperLayer;
...
public class PocketSeaCreeperRenderer extends GeoEntityRenderer<PocketSeaCreeperEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, PocketSeaCreeperEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
