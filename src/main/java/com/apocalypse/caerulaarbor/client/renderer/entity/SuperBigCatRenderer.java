...
import com.apocalypse.caerulaarbor.client.model.entity.layer.SuperBigCatLayer;
import com.apocalypse.caerulaarbor.client.model.entity.SuperBigCatModel;
...
public class SuperBigCatRenderer extends GeoEntityRenderer<SuperBigCatEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SuperBigCatEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
