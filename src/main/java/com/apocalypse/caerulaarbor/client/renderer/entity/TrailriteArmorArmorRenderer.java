...
import com.apocalypse.caerulaarbor.client.model.item.TrailriteArmorModel;
...
public class TrailriteArmorArmorRenderer extends GeoArmorRenderer<TrailriteArmorItem> {
	public TrailriteArmorArmorRenderer() {
		super(new TrailriteArmorModel());
	...
	@Override
	public RenderType getRenderType(TrailriteArmorItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
