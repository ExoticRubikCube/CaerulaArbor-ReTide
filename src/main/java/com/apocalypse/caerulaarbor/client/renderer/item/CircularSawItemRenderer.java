...
import com.apocalypse.caerulaarbor.client.model.item.CircularSawItemModel;
...
public class CircularSawItemRenderer extends GeoItemRenderer<CircularSawItem> {
	...
	@Override
	public RenderType getRenderType(CircularSawItem animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
	...
	@Override
	public ResourceLocation getTextureLocation(CircularSawItem instance) {
