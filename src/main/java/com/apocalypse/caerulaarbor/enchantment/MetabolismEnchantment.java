...
public class MetabolismEnchantment extends Enchantment {
	private static final EnchantmentCategory ENCHANTMENT_CATEGORY = EnchantmentCategory.create("caerula_arbor_metabolism", item -> Ingredient.of(new ItemStack(CAItems.PHLOEM_BOW.get())).test(new ItemStack(item)));
