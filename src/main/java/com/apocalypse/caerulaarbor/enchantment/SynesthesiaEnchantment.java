...
public class SynesthesiaEnchantment extends Enchantment {
	private static final EnchantmentCategory ENCHANTMENT_CATEGORY = EnchantmentCategory.create("caerula_arbor_synesthesia",
			item -> Ingredient.of(new ItemStack(CaerulaArborModItems.LEGENDARY_SPEAR.get()), new ItemStack(CaerulaArborModItems.HIGHMORE_SCYTHE.get()), new ItemStack(CaerulaArborModItems.DRAGON_WAND.get())).test(new ItemStack(item)));
