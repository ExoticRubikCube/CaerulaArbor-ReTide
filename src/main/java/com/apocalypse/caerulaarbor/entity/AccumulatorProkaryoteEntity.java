                        ...
                        CaerulaArborMod.queueServerWork(10, () -> {
                            ...
                            if (world instanceof Level _level) {
                                if (!_level.isClientSide()) {
                                    ...
                                    _level.playLocalSound((getX()), (getY()), (getZ()), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.puffer_fish.blow_out")), SoundSource.HOSTILE, 2, 1, false);
                                }
                            }
                        });
                    }
