...
public class Al1SHelperEntity extends PathfinderMob implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(Al1SHelperEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(Al1SHelperEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(Al1SHelperEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<Integer> DATA_durability = SynchedEntityData.defineId(Al1SHelperEntity.class, EntityDataSerializers.INT);
	...
	public Al1SHelperEntity(EntityType<Al1SHelperEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setMaxUpStep(1f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "little_helper_al1s");
	...
	protected void tickDeath() {
		++this.deathTime;
		if (this.deathTime == 5) {
			this.remove(Al1SHelperEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
