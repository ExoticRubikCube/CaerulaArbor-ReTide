...
public class CarmenBulletEntity extends AbstractArrow implements ItemSupplier {
	...
	public static CarmenBulletEntity shoot(Level world, LivingEntity entity, RandomSource source) {
		return shoot(world, entity, source, 1.5f, 5, 0);
	}

	public static CarmenBulletEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
