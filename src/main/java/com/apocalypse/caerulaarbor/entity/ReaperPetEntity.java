...
public class ReaperPetEntity extends TamableAnimal implements GeoEntity {
            ...
            if (((Entity) sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Blocks.AIR.asItem()
                ...
                if ((LevelAccessor) world instanceof Level _level) {
                    if (!_level.isClientSide()) {
                        ...
                        _level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.dolphin.eat")), SoundSource.NEUTRAL, 1, 1, false);
                    }
                }
                return InteractionResult.SUCCESS;
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ReaperPetEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
