...
public class WarriorPriestEntity extends Animal implements GeoEntity {
	...
	public WarriorPriestEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CaerulaArborModEntities.WARRIOR_PRIEST.get(), world);
	}
                        ...
                        if (sourceentity.isAlive()) {
                            ...
                            if (world instanceof Level _level) {
                                if (!_level.isClientSide()) {
                                    ...
                                    _level.playLocalSound(x, y, z, ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("intentionally_empty")), SoundSource.HOSTILE, (float) 2.5, 1, false);
                                }
                            }
                            sourceentity.hurt(
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		WarriorPriestEntity retval = CaerulaArborModEntities.WARRIOR_PRIEST.get().create(serverWorld);
