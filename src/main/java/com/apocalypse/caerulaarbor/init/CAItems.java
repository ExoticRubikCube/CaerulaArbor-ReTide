...
public class CAItems {
	...
	public static final RegistryObject<Item> IZUMIK_SPAWNEGG = registerTooltipSpawnEgg("izumik_spawnegg", CAEntities.IZUMIK, -1, -1, new Item.Properties().stacksTo(64).rarity(Rarity.EPIC),
	...
	public static final RegistryObject<Item> ISHARMLA_SPAWNER = registerTooltipSpawnEgg("isharmla_spawner", CAEntities.ISHARMLA, -1, -1, new Item.Properties().stacksTo(64).rarity(Rarity.EPIC),
	...
	public static final RegistryObject<Item> ENDERINA_SPAWNER = registerTooltipSpawnEgg("enderina_spawner", CAEntities.OCEANIZED_ENDERINA, -1, -1, new Item.Properties().stacksTo(64).rarity(Rarity.EPIC),
