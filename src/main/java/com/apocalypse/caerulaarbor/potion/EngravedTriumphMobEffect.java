...
public class EngravedTriumphMobEffect extends MobEffect {
    public EngravedTriumphMobEffect() {
        ...
        this.addAttributeModifier(CaerulaArborModAttributes.MAGIC_RESISTANCE.get(), "10c5f399-c9c7-303e-a104-ba1499e7a8bc", 0.25, AttributeModifier.Operation.ADDITION);
        this.addAttributeModifier(CaerulaArborModAttributes.GENERAL_DEFENSE.get(), "d0105d7e-b5da-3757-bed1-8bec5afeb872", 0.01, AttributeModifier.Operation.MULTIPLY_BASE);
    }
