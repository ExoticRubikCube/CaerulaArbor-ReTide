...
public class WipeDustsMobEffect extends MobEffect {
    ...
    public void applyEffectTick(LivingEntity entity, int amplifier) {
        ...
        if (entity == null)
            return;
        if ((Entity) entity instanceof LivingEntity _livEnt0 && _livEnt0.hasEffect(MobEffects.REGENERATION) && ((Entity) entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(Items.BRUSH)) : false)) {
            {
