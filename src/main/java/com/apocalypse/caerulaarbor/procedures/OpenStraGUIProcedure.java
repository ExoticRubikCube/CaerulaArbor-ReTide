...
public class OpenStraGUIProcedure {
	public static InteractionResult execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof LivingEntity _entity && _entity.isHolding(CaerulaArborModItems.DICTATIONLESS_CHAPTER.get())) {
			return InteractionResult.PASS;
		} else if (entity instanceof LivingEntity _entity && _entity.isHolding(CaerulaArborModItems.DICTATION_CHAPTER.get())) {
			return InteractionResult.PASS;
		}
