...
public class CustomBossBarEventHandler {
    ...
    public static final ResourceLocation GENERIC = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/generic_bossbar.png");
    public static final ResourceLocation PATHSHAPER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/path_shaper_bossbar.png");
    public static final ResourceLocation LINGERING = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/lingering_shaper_bossbar.png");
    public static final ResourceLocation QUINTUS = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/quintus_bossbar.png");
    public static final ResourceLocation T_BISHOP = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/tidelinked_bishop_bossbar.png");
    public static final ResourceLocation T_IMMORTAL = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/tidelinked_immortal_bossbar.png");
    public static final ResourceLocation T_ARCHON = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/tidelinked_archon_bossbar.png");
    public static final ResourceLocation HIGHMORE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/highmore_bossbar.png");
    public static final ResourceLocation IZUMIK = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/izumik_bossbar.png");
    public static final ResourceLocation MARTUS = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/martus_bossbar.png");
    public static final ResourceLocation LAST_KNIGHT = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/the_last_knight_bossbar.png");
    public static final ResourceLocation CORRUPTED = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/corrupted_bossbar.png");
    public static final ResourceLocation PURIFIED = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/corrupted_bossbar_purify.png");
    public static final ResourceLocation ISHARMLA_HUMAN = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/isharmla_bossbar.png");
    public static final ResourceLocation ISHARMLA_M3 = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/isharmla_monster_bossbar.png");
    public static final ResourceLocation THIRSTER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/thirster_bossbar.png");
    public static final ResourceLocation THIRSTER_BARRIER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/thirster_bossbar_barrier.png");
    public static final ResourceLocation FLAMARINE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/flamarine_bossbar.png");
    public static final ResourceLocation WITHER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/wither_bossbar.png");
    public static final ResourceLocation WITHERIA = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/witheria_bossbar.png");
    public static final ResourceLocation WARDEN = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/warden_bossbar.png");
    public static final ResourceLocation WARDENIS = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/wardenis_bossbar.png");
    public static final ResourceLocation ENDERINA = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/enderina_bossbar.png");
    public static final ResourceLocation ENDSPEAKER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/endspeaker_bossbar.png");
    public static final ResourceLocation WITHER_STYLE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/wither_bossstyle.png");
    public static final ResourceLocation WARDEN_STYLE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/bossbar/warden_bossstyle.png");
    public static final ResourceLocation ENDERINA_STYLE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/screen/enderina_style.png");
