...
public class CustomBossBarOverlay {
    ...
    public static final ResourceLocation GENERIC = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/generic_bossbar.png");
    public static final ResourceLocation PATHSHAPER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/path_shaper_bossbar.png");
    public static final ResourceLocation LINGERING = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/lingering_shaper_bossbar.png");
    public static final ResourceLocation QUINTUS = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/quintus_bossbar.png");
    public static final ResourceLocation T_BISHOP = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/tidelinked_bishop_bossbar.png");
    public static final ResourceLocation T_IMMORTAL = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/tidelinked_immortal_bossbar.png");
    public static final ResourceLocation T_ARCHON = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/tidelinked_archon_bossbar.png");
    public static final ResourceLocation HIGHMORE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/highmore_bossbar.png");
    public static final ResourceLocation IZUMIK = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/izumik_bossbar.png");
    public static final ResourceLocation MARTUS = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/martus_bossbar.png");
    public static final ResourceLocation LAST_KNIGHT = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/the_last_knight_bossbar.png");
    public static final ResourceLocation CORRUPTED = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/corrupted_bossbar.png");
    public static final ResourceLocation PURIFIED = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/corrupted_bossbar_purify.png");
    public static final ResourceLocation ISHARMLA_HUMAN = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/isharmla_bossbar.png");
    public static final ResourceLocation ISHARMLA_M3 = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/isharmla_monster_bossbar.png");
    public static final ResourceLocation THIRSTER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/thirster_bossbar.png");
    public static final ResourceLocation THIRSTER_BARRIER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/thirster_bossbar_barrier.png");
    public static final ResourceLocation FLAMARINE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/flamarine_bossbar.png");
    public static final ResourceLocation WITHER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/wither_bossbar.png");
    public static final ResourceLocation WITHERIA = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/gui/overlay/bossbar/witheria_bossbar.png");
    ...
    static{
        ...
        INDEX.add(Pair.of("entity.caerula_arbor.oceanized_ender_dragon",CONTEXT_ENDER_DRAGON));
