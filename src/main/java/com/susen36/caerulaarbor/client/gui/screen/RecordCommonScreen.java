...
public class RecordCommonScreen extends CaerulaRecordGUIScreen {
	public RecordCommonScreen(CaerulaRecordGUIMenu container, Inventory inventory, Component text) {
		super(container, inventory, text);
	}

	@Override
	public RecordColor recordColor() {
		return RecordColor.PARCHMENT;
	}
