...
public class BishopFishModel extends GeoModel<BishopFishEntity> {
	...
	public ResourceLocation getAnimationResource(BishopFishEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/bishop.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(BishopFishEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/bishop.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(BishopFishEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/bishop.png");
	}
