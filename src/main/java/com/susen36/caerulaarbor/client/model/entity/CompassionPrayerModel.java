...
public class CompassionPrayerModel extends GeoModel<CompassionPrayerEntity> {
	private static final ResourceLocation PHASE_0_TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/compassion_prayer.png");
	private static final ResourceLocation PHASE_1_TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/compassion_prayer_a.png");

	@Override
	public ResourceLocation getAnimationResource(CompassionPrayerEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/compassion_prayer.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(CompassionPrayerEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/compassion_prayer.geo.json");
	}
