...
public class CrackerAbyssalModel extends GeoModel<CrackerAbyssalEntity> {
	...
	public ResourceLocation getAnimationResource(CrackerAbyssalEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/nethersea_reefbreaker.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(CrackerAbyssalEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/nethersea_reefbreaker.geo.json");
	}
