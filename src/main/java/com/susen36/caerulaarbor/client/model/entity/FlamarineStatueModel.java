...
public class FlamarineStatueModel extends GeoModel<FlamarineStatueEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/living_armor.png");

	@Override
	public ResourceLocation getAnimationResource(FlamarineStatueEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/living_armor.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(FlamarineStatueEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/living_armor.geo.json");
	}
