...
public class HighmoreModel extends GeoModel<HighmoreEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArborMod.MODID, "textures/entities/highmore.png");

	@Override
	public ResourceLocation getAnimationResource(HighmoreEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArborMod.MODID, "animations/highmore.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(HighmoreEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArborMod.MODID, "geo/highmore.geo.json");
	}
