...
public class LastKnightAndHorseModel extends GeoModel<LastKnightAndHorseEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/knight_amd_horse.png");

	@Override
	public ResourceLocation getAnimationResource(LastKnightAndHorseEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/last_knight_horse.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(LastKnightAndHorseEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/last_knight_horse.geo.json");
	}
