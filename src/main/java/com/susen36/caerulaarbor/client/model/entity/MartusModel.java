...
public class MartusModel extends GeoModel<MartusEntity> {
	...
	public ResourceLocation getAnimationResource(MartusEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/martus.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(MartusEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/martus.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(MartusEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/martus.png");
	}
