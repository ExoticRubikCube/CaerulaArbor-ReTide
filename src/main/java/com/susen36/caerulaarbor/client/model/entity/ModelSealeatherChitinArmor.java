...
public class ModelSealeatherChitinArmor<T extends Entity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "sealeather_chitin_armor"), "main");
