...
public class MoistEnderCrystalModel extends GeoModel<MoistEnderCrystalEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/moist_crystal.png");

	@Override
	public ResourceLocation getAnimationResource(MoistEnderCrystalEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/moist_crystal.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(MoistEnderCrystalEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/moist_crystal.geo.json");
	}
