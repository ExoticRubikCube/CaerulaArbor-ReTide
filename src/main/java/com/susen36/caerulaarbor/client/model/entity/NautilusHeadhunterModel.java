...
public class NautilusHeadhunterModel extends GeoModel<NautilusHeadhunterEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/nautilus_headhunter.png");

	@Override
	public ResourceLocation getAnimationResource(NautilusHeadhunterEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/nultilus_headhunter.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(NautilusHeadhunterEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/nultilus_headhunter.geo.json");
	}
