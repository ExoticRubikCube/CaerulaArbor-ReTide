...
public class OceanizedCowModel extends GeoModel<OceanizedCowEntity> {
	private static final ResourceLocation TRAIL_TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/oceanzied_cow.png");
	private static final ResourceLocation TRAILLESS_TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/oceanzied_cow_trailless.png");

	@Override
	public ResourceLocation getAnimationResource(OceanizedCowEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/oceanized_cow.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(OceanizedCowEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/oceanized_cow.geo.json");
	}
