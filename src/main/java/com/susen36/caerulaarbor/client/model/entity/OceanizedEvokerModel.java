...
public class OceanizedEvokerModel extends GeoModel<OceanizedEvokerEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/oceanized_evoker.png");

	@Override
	public ResourceLocation getAnimationResource(OceanizedEvokerEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/oceanized_evoker.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(OceanizedEvokerEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/oceanized_evoker.geo.json");
	}
