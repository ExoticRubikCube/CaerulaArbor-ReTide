...
public class OceanizedPiglinModel extends GeoModel<OceanizedPiglinEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/oceanized_piglin.png");

	@Override
	public ResourceLocation getAnimationResource(OceanizedPiglinEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/oceanized_piglin.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(OceanizedPiglinEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/oceanized_piglin.geo.json");
	}
