...
public class OceanizedPillagerModel extends GeoModel<OceanizedPillagerEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/oceanized_pillager.png");

	@Override
	public ResourceLocation getAnimationResource(OceanizedPillagerEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/oceanized_pillager.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(OceanizedPillagerEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/oceanized_pillager.geo.json");
	}
