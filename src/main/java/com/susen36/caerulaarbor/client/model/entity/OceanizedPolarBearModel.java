...
public class OceanizedPolarBearModel extends GeoModel<OceanizedPolarBearEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/oceanized_polar.png");

	@Override
	public ResourceLocation getAnimationResource(OceanizedPolarBearEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/oceanized_polarbear.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(OceanizedPolarBearEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/oceanized_polarbear.geo.json");
	}
