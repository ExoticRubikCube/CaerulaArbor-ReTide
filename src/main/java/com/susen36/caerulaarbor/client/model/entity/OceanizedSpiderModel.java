...
public class OceanizedSpiderModel extends GeoModel<OceanizedSpiderEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/oceanized_spider.png");

	@Override
	public ResourceLocation getAnimationResource(OceanizedSpiderEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/oceanized_spider.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(OceanizedSpiderEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/oceanized_spider.geo.json");
	}
