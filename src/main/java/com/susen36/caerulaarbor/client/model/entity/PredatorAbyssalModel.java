...
public class PredatorAbyssalModel extends GeoModel<PredatorAbyssalEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/predator.png");

	@Override
	public ResourceLocation getAnimationResource(PredatorAbyssalEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/predator.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(PredatorAbyssalEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/predator.geo.json");
	}
