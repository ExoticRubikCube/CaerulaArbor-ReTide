...
public class RocinanteModel extends GeoModel<RocinanteEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/mere_horse.png");

	@Override
	public ResourceLocation getAnimationResource(RocinanteEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/rocinante.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(RocinanteEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/rocinante.geo.json");
	}
