...
public class SaintCarmenModel extends GeoModel<SaintCarmenEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/saint_carmen.png");

	@Override
	public ResourceLocation getAnimationResource(SaintCarmenEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/saint_carmen.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(SaintCarmenEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/saint_carmen.geo.json");
	}
