...
public class SkadiModel extends GeoModel<SkadiEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/hunter_skadi.png");

	@Override
	public ResourceLocation getAnimationResource(SkadiEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/skadi.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(SkadiEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/skadi.geo.json");
	}
