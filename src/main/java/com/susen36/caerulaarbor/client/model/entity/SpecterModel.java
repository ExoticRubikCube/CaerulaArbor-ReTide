...
public class SpecterModel extends GeoModel<SpecterEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/hunter_specter.png");

	@Override
	public ResourceLocation getAnimationResource(SpecterEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/specter.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(SpecterEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/specter.geo.json");
	}
