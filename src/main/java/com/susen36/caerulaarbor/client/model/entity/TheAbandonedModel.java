...
public class TheAbandonedModel extends GeoModel<TheAbandonedEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/theabandoned_texture.png");

	@Override
	public ResourceLocation getAnimationResource(TheAbandonedEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/the_abandoned.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(TheAbandonedEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/the_abandoned.geo.json");
	}
