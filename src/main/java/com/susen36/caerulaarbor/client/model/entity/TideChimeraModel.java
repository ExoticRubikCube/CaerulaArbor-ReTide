...
public class TideChimeraModel extends GeoModel<TideChimeraEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/general_seaborns.png");

	@Override
	public ResourceLocation getAnimationResource(TideChimeraEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/super_apocata.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(TideChimeraEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/super_apocata.geo.json");
	}
	...
	public void setCustomAnimations(TideChimeraEntity animatable, long instanceId, AnimationState<TideChimeraEntity> animationState) {
		GeoBone head = getAnimationProcessor().getBone("forHead");
		if (head != null) {
