...
public class TideutantRockSpiderModel extends GeoModel<TideutantRockSpiderEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/tideutant_rock_spider.png");

	@Override
	public ResourceLocation getAnimationResource(TideutantRockSpiderEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/tidutant_rock_spider.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(TideutantRockSpiderEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/tidutant_rock_spider.geo.json");
	}
