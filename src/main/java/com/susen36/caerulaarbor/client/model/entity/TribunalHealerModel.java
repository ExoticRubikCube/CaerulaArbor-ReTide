...
public class TribunalHealerModel extends GeoModel<TribunalHealerEntity> {
	private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/tribunalhealer.png");

	@Override
	public ResourceLocation getAnimationResource(TribunalHealerEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "animations/tribunal_healer.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(TribunalHealerEntity entity) {
		return ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "geo/tribunal_healer.geo.json");
	}
