...
public class CorrectionalPhalanxyInfantryLayer extends GeoRenderLayer<CorrectionalPhalanxyInfantryEntity> {
	...
	@Override
	public void render(PoseStack poseStack, CorrectionalPhalanxyInfantryEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight,
			int packedOverlay) {
