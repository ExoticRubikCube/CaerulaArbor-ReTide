...
public class HighmoreLayer extends GeoRenderLayer<HighmoreEntity> {
	private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/highmorelit.png");
	...
	@Override
	public void render(PoseStack poseStack, HighmoreEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
