...
public class IsharmlaTearLayer extends GeoRenderLayer<IsharmlaTearEntity> {
	private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/isharmla_tear_lit.png");
	...
	@Override
	public void render(PoseStack poseStack, IsharmlaTearEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
