...
public class MoistDragonBreathLayer extends GeoRenderLayer<MoistDragonBreathEntity> {
	private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/dragon_ball_lit.png");
	...
	@Override
	public void render(PoseStack poseStack, MoistDragonBreathEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
