...
public class OceanizedDogLayer extends GeoRenderLayer<OceanizedDogEntity> {
	private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/dog_lit.png");
	...
	@Override
	public void render(PoseStack poseStack, OceanizedDogEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
