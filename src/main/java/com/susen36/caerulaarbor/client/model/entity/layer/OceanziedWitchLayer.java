...
public class OceanziedWitchLayer extends GeoRenderLayer<OceanziedWitchEntity> {
	private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/witch_lit.png");
	...
	@Override
	public void render(PoseStack poseStack, OceanziedWitchEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
