...
public class SaintCarmenLayer extends GeoRenderLayer<SaintCarmenEntity> {
	private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/carmen_lit.png");
	...
	@Override
	public void render(PoseStack poseStack, SaintCarmenEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
