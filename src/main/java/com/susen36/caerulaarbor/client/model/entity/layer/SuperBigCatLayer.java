...
public class SuperBigCatLayer extends GeoRenderLayer<SuperBigCatEntity> {
	private static final ResourceLocation LAYER = ResourceLocation.fromNamespaceAndPath(CaerulaArbor.MODID, "textures/entities/suprcat_lit.png");
	...
	@Override
	public void render(PoseStack poseStack, SuperBigCatEntity animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
