...
public class AccumulatorCloneRenderer extends GeoEntityRenderer<AccumulatorCloneEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, AccumulatorCloneEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
