...
public class AccumulatorProkaryoteRenderer extends GeoEntityRenderer<AccumulatorProkaryoteEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, AccumulatorProkaryoteEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
