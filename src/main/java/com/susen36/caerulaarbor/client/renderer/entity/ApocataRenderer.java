...
public class ApocataRenderer extends GeoEntityRenderer<ApocataEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ApocataEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
