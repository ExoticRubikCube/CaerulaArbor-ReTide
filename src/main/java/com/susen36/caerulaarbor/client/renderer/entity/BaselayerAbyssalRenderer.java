...
import com.susen36.caerulaarbor.client.model.entity.BaselayerAbyssalModel;
...
public class BaselayerAbyssalRenderer extends GeoEntityRenderer<BaselayerAbyssalEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, BaselayerAbyssalEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1.4f;
