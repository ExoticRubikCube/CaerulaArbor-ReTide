...
import com.susen36.caerulaarbor.client.model.entity.BishopFishModel;
import com.susen36.caerulaarbor.client.model.entity.layer.BishopFishLayer;
...
public class BishopFishRenderer extends GeoEntityRenderer<BishopFishEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, BishopFishEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1.5f;
