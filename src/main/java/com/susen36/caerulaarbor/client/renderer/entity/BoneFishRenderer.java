...
import com.susen36.caerulaarbor.client.model.entity.BoneFishModel;
...
public class BoneFishRenderer extends GeoEntityRenderer<BoneFishEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, BoneFishEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 0.8f;
