...
import com.susen36.caerulaarbor.client.model.entity.ChitinGolemModel;
import com.susen36.caerulaarbor.client.model.entity.layer.ChitinGolemLayer;
...
public class ChitinGolemRenderer extends GeoEntityRenderer<ChitinGolemEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ChitinGolemEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
