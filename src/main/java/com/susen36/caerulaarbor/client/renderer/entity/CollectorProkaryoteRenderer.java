...
import com.susen36.caerulaarbor.client.model.entity.CollectorProkaryoteModel;
import com.susen36.caerulaarbor.client.model.entity.layer.CollectorProkaryoteLayer;
...
public class CollectorProkaryoteRenderer extends GeoEntityRenderer<CollectorProkaryoteEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, CollectorProkaryoteEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 0.6f;
