...
import com.susen36.caerulaarbor.client.model.entity.ComplexChitinGolemModel;
import com.susen36.caerulaarbor.client.model.entity.layer.ComplexChitinGolemLayer;
...
public class ComplexChitinGolemRenderer extends GeoEntityRenderer<ComplexChitinGolemEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, ComplexChitinGolemEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1.5f;
