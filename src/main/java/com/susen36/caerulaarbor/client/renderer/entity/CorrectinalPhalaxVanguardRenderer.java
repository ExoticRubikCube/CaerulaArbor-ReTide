...
public class CorrectinalPhalaxVanguardRenderer extends GeoEntityRenderer<CorrectinalPhalaxVanguardEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, CorrectinalPhalaxVanguardEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
