...
import com.susen36.caerulaarbor.client.model.entity.FakeOffspringModel;
...
public class FakeOffspringRenderer extends GeoEntityRenderer<FakeOffspringEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FakeOffspringEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
