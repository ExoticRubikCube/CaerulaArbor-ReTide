...
import com.susen36.caerulaarbor.client.model.entity.FlamarineGolemModel;
...
public class FlamarineGolemRenderer extends GeoEntityRenderer<FlamarineGolemEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, FlamarineGolemEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1.25f;
