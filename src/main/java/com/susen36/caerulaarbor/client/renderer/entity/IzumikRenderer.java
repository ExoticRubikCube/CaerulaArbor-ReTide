...
public class IzumikRenderer extends GeoEntityRenderer<IzumikEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, IzumikEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1.5f;
