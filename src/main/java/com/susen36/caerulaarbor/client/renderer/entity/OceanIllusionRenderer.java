...
public class OceanIllusionRenderer extends GeoEntityRenderer<OceanIllusionEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanIllusionEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
