...
public class OceanizedDogRenderer extends GeoEntityRenderer<OceanizedDogEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedDogEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
