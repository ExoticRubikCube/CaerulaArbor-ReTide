...
public class OceanizedEnderinaRenderer extends GeoEntityRenderer<OceanizedEnderinaEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedEnderinaEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
