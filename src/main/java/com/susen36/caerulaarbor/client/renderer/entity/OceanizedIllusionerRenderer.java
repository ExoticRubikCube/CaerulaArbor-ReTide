...
import com.susen36.caerulaarbor.client.model.entity.OceanizedIllusionerModel;
import com.susen36.caerulaarbor.client.model.entity.layer.OceanizedIllusionerLayer;
...
public class OceanizedIllusionerRenderer extends GeoEntityRenderer<OceanizedIllusionerEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedIllusionerEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
