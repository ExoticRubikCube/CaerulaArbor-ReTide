...
import com.susen36.caerulaarbor.client.model.entity.OceanizedPillagerModel;
import com.susen36.caerulaarbor.client.model.entity.layer.OceanizedPillagerLayer;
...
public class OceanizedPillagerRenderer extends GeoEntityRenderer<OceanizedPillagerEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedPillagerEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
