...
import com.susen36.caerulaarbor.client.model.entity.OceanizedRavagerModel;
...
public class OceanizedRavagerRenderer extends GeoEntityRenderer<OceanizedRavagerEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedRavagerEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
