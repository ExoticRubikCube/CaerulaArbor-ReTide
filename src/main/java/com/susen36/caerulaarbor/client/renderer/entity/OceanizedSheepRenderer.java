...
public class OceanizedSheepRenderer extends GeoEntityRenderer<OceanizedSheepEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedSheepEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
