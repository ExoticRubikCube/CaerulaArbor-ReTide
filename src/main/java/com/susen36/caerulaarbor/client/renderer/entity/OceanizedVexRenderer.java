...
public class OceanizedVexRenderer extends GeoEntityRenderer<OceanizedVexEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedVexEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
