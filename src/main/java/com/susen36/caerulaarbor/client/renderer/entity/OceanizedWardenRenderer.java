...
public class OceanizedWardenRenderer extends GeoEntityRenderer<OceanizedWardenEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedWardenEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
