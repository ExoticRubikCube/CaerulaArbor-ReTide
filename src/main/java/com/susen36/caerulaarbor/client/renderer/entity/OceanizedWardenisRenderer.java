...
public class OceanizedWardenisRenderer extends GeoEntityRenderer<OceanizedWardenisEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OceanizedWardenisEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
