...
public class QunyouWantedIsharmlaRenderer extends GeoEntityRenderer<QunyouWantedIsharmlaEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, QunyouWantedIsharmlaEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 3f;
