...
import com.susen36.caerulaarbor.client.model.entity.RocinanteModel;
...
public class RocinanteRenderer extends GeoEntityRenderer<RocinanteEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, RocinanteEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
