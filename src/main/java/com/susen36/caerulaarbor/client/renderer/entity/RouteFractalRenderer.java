...
import com.susen36.caerulaarbor.client.model.entity.RouteFractalModel;
...
public class RouteFractalRenderer extends GeoEntityRenderer<RouteFractalEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, RouteFractalEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 0.75f;
