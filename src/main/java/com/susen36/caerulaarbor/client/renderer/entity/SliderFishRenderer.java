...
import com.susen36.caerulaarbor.client.model.entity.SliderFishModel;
...
public class SliderFishRenderer extends GeoEntityRenderer<SliderFishEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SliderFishEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1.5f;
