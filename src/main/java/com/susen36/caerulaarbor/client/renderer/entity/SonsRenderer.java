...
public class SonsRenderer extends GeoEntityRenderer<SonsEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SonsEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
