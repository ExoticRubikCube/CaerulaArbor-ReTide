...
import com.susen36.caerulaarbor.client.model.entity.SplasherAbyssalModel;
...
public class SplasherAbyssalRenderer extends GeoEntityRenderer<SplasherAbyssalEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SplasherAbyssalEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
