...
import com.susen36.caerulaarbor.client.model.entity.SuperSliderModel;
...
public class SuperSliderRenderer extends GeoEntityRenderer<SuperSliderEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, SuperSliderEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 10f;
