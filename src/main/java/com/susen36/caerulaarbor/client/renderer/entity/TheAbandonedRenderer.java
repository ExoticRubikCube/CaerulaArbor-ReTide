...
import com.susen36.caerulaarbor.client.model.entity.layer.TheAbandonedLayer;
import com.susen36.caerulaarbor.client.model.entity.TheAbandonedModel;
...
public class TheAbandonedRenderer extends GeoEntityRenderer<TheAbandonedEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, TheAbandonedEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
