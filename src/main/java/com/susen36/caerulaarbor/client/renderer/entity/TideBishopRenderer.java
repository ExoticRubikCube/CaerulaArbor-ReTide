...
public class TideBishopRenderer extends GeoEntityRenderer<TideBishopEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, TideBishopEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1.5f;
