...
public class TideChimeraRenderer extends GeoEntityRenderer<TideChimeraEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, TideChimeraEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
