...
import com.susen36.caerulaarbor.client.model.entity.TideDeathrepellerModel;
...
public class TideDeathrepellerRenderer extends GeoEntityRenderer<TideDeathrepellerEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, TideDeathrepellerEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1.2f;
