...
import com.susen36.caerulaarbor.client.model.entity.TideutantRockSpiderModel;
...
public class TideutantRockSpiderRenderer extends GeoEntityRenderer<TideutantRockSpiderEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, TideutantRockSpiderEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int color) {
		float scale = 1f;
