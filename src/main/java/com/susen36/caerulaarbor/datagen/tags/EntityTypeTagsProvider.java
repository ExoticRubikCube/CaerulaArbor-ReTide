...
public class EntityTypeTagsProvider extends TagsProvider.RegistryTagsProvider<EntityType<?>> {
    ...
    private static final TagKey<EntityType<?>> SEA_BORN_PET = caEntityTypeTag("sea_born_pet");
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        addTagsToTag(IS_HUMANSIDE, HUNTERS, INQUISITION, SEA_BORN_PET);
        ...
        addEntityTypesToTag(SEA_BORN_PET, CAEntities.REAPER_PET, CAEntities.OCEANIZED_DOG, CAEntities.ROCINANTE);
