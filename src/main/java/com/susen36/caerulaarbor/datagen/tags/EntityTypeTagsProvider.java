...
public class EntityTypeTagsProvider extends TagsProvider.RegistryTagsProvider<EntityType<?>> {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        addEntityTypesToTag(ELITE, CAEntities.BASELAYER_ABYSSAL, CAEntities.CRACKER_ABYSSAL, CAEntities.POCKET_SEA_CREEPER, CAEntities.FIRST_TO_TALK, CAEntities.SKIMMING_SEA_DRIFTER, CAEntities.GUIDE_ABYSSAL, CAEntities.PREGNANT_FISH, CAEntities.PUNCTURE_FISH, CAEntities.REAPER_FISH, CAEntities.UMBRELLA_ABYSSAL, CAEntities.MEGA_CHEST, CAEntities.APOSTLE_PROKARYOTE, CAEntities.CHEST_FISH, CAEntities.OCEANIZED_VINDICATOR, CAEntities.OCEANIZED_ENDERMAN, CAEntities.OCEANIZED_RAVAGER, CAEntities.IZUMIK_OFFSPRING, CAEntities.OCEANIZED_EVOKER, CAEntities.THE_ABANDONED, CAEntities.NUCLEIC_MALEFICENT, CAEntities.TIDUTANT_ROCK_SPIDER, CAEntities.SCREAM_CHEST_FISH, CAEntities.OCEANIZED_SHULKER);
        addEntityTypesToTag(SEABORN_PET, CAEntities.REAPER_PET, CAEntities.OCEANIZED_DOG, CAEntities.ROCINANTE);
        addEntityTypesToTag(SEABORN_MINION, CAEntities.MOIST_ENDER_CRYSTAL, CAEntities.ISHARMLA_TEAR);
        ...
        addEntityTypesToTag(WITH_LOWEST_SMALLEST_ELEMENTAL_MODIFIER, EntityType.IRON_GOLEM, CAEntities.CHITIN_GOLEM, CAEntities.THE_LAST_KNIGHT, CAEntities.COMPLEX_CHITIN_GOLEM, CAEntities.FLAMARINE_STATUE, CAEntities.FLAMARINE_GOLEM);
