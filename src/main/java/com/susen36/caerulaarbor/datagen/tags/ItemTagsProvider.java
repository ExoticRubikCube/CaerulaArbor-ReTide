...
public class ItemTagsProvider extends TagsProvider.RegistryTagsProvider<Item> {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        addItemsToTag(COMMON_RELICS, CACollectible.SOLO_MUSIC_BOX, CACollectible.ODD_FLUTE, CACollectible.TOPONYM_TEXTOLOGY, CACollectible.UTIL_ALLAY, CACollectible.UTIL_SCORE, CACollectible.UTIL_RESCISSION, CACollectible.HEMOST);
