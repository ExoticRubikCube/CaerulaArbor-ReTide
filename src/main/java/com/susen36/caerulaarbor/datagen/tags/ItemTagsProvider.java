...
public class ItemTagsProvider extends TagsProvider.RegistryTagsProvider<Item> {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        addItemsToTag(COMMON_RELICS, CACollectible.SOLO_MUSIC_BOX, CACollectible.ODD_FLUTE, CACollectible.TOPONYM_TEXTOLOGY, CACollectible.UTIL_ALLAY, CACollectible.UTIL_RESCISSION, CACollectible.HEMOST);
        ...
        addItemsToTag(GENE, CAItems.DNA_REAPER, CAItems.HUNTER_GENE, CAItems.DNA_HORSE, CAItems.ROCINANTE_INJECTOR, CAItems.HUNTER_GENE_SKADI, CAItems.HUNTER_GENE_ULPIANS, CAItems.HUNTER_GENE_GLADIIA, CAItems.HUNTER_GENE_SPECTER, CACollectible.NURTURE_GENE_SET, CAItems.EVOLUTIONARY_GENE, CAItems.EVOLUTIONARY_GENOME, CAItems.EXPERIMENTAL_GENE);
        ...
        addItemsToTag(RELIC_GENERIC, CACollectible.SURVIVOR_CONTRACT, CACollectible.TREATY, CACollectible.BOWL_SEAGRASS, CACollectible.GOLDEN_STORM, CACollectible.COFFEE_CANDY, CACollectible.CANNED_CHERRY, CACollectible.SOLO_MUSIC_BOX, CACollectible.ODD_FLUTE, CACollectible.TOPONYM_TEXTOLOGY, CACollectible.CHITIN_KNIFE, CACollectible.UTIL_ALLAY, CACollectible.PROOF_OF_LONGEVITY, CACollectible.UTIL_RESCISSION, CACollectible.UTIL_STARE, CACollectible.YEARNING, CACollectible.FEATURED_CANNED_MEAT, CACollectible.HEMOST);
        ...
        addItemsToTag(MINECRAFT_BOOKSHELF_BOOKS, CACollectible.SURVIVOR_CONTRACT, CACollectible.TOPONYM_TEXTOLOGY, CAItems.MARTUS_BOOK, CAItems.DICTATIONLESS_CHAPTER, CACollectible.CURSED_RESEARCH, CAItems.DICTATION_CHAPTER);
        ...
        addItemsToTag(MINECRAFT_MUSIC_DISCS, CAItems.RECORD_ISHARMLA, CAItems.RECORD_DEEPNESS, CAItems.RECORD_UNDERTIDES, CAItems.RECORD_PATH_AHEAD, CAItems.RECORD_ENDOSPORE, CAItems.RECORD_WHISPER, CAItems.RECORD_OCEANWISH, CAItems.RECORD_UNDERDAWN, CAItems.RECORD_MARE_NATUS);
        ...
        addItemsToTag(MINECRAFT_PIGLIN_LOVED, CAItems.TRAILED_GOLDEN_SWORD, CAItems.TRAIL_GOLDEN_APPLE);
