...
public class ItemTagsProvider extends TagsProvider.RegistryTagsProvider<Item> {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        addItemsToTag(ARCHFIEND_RELICS, CAItems.ARCHFIENDS_ARTIFACT, CAItems.ARCHFIENDS_FLAG, CAItems.ARCHFIENDS_BED, CACollectible.ROYAL_FATE);
        addItemsToTag(COMMON_RELICS, CAItems.AROMATIC_COFFEE, CACollectible.SOLO_MUSIC_BOX, CACollectible.REDSTONE_IRIS_FLOWER, CACollectible.ODD_FLUTE, CACollectible.VOYAGE_OF_GOLD, CAItems.PIGLIN_DIARY, CACollectible.TOPONYM_TEXTOLOGY, CACollectible.KETTLE, CAItems.ALLAY_SCULPTURE, CAItems.BAT_BED, CAItems.OMNI_KEY, CAItems.SCORE, CAItems.RESCISSION, CAItems.SMELLY_HEMOSTATIC);
        ...
        addItemsToTag(HAND_RELICS, CAItems.HAND_OF_THORNS, CAItems.HAND_OF_STRANGLE, CAItems.HAND_OF_FERTILIY, CAItems.HAND_OF_SPEED, CAItems.HAND_OF_BARREN, CAItems.HAND_OF_SPOTLESS, CAItems.HAND_OF_FIREWORK, CACollectible.HAND_OF_ENGRAVE, CACollectible.HAND_SWORD);
        addItemsToTag(KING_RELICS, CACollectible.RELIC_CROWN, CAItems.KINGS_ARMOUR, CAItems.KINGS_SPEAR, CAItems.KINGS_EXTENSION, CAItems.KINGS_CRYSTAL);
        ...
        addItemsToTag(RELIC_GENERIC, CACollectible.SURVIVOR_CONTRACT, CAItems.CRIMSON_TREATY, CACollectible.BOWL_SEAGRASS, CACollectible.GOLDEN_STORM, CAItems.COFFEE_CANDY, CACollectible.CANNED_CHERRY, CAItems.RAINBOW_CANDY, CAItems.AROMATIC_COFFEE, CACollectible.SOLO_MUSIC_BOX, CACollectible.REDSTONE_IRIS_FLOWER, CACollectible.ODD_FLUTE, CACollectible.VOYAGE_OF_GOLD, CAItems.PIGLIN_DIARY, CACollectible.TOPONYM_TEXTOLOGY, CACollectible.KETTLE, CAItems.CHITIN_KNIFE, CAItems.ALLAY_SCULPTURE, CAItems.BAT_BED, CACollectible.PROOF_OF_LONGEVITY, CAItems.OMNI_KEY, CAItems.SCORE, CAItems.RESCISSION, CAItems.GUARDIAN_STARE, CAItems.UNRIPE_YEARNING, CAItems.MEAT_CAN, CAItems.SMELLY_HEMOSTATIC);
        ...
        addItemsToTag(MINECRAFT_MEAT, CAItems.BROKEN_CELL_CLUSTER, CAItems.CELL_CLUSTER, CAItems.COLLECTOR_MEAT, CAItems.KEBAB_RAW, CAItems.KEBAB_COOKED, CAItems.MEAT_CAN, CAItems.NETHERSEA_EGG_CUSTARD, CAItems.OCEAN_EYE, CAItems.OCEAN_PEDUNCLE, CAItems.TRANSFORM_CELL);
        ...
        addItemsToTag(MINECRAFT_BOOKSHELF_BOOKS, CACollectible.SURVIVOR_CONTRACT, CAItems.PIGLIN_DIARY, CACollectible.TOPONYM_TEXTOLOGY, CAItems.MARTUS_BOOK, CAItems.DICTATIONLESS_CHAPTER, CACollectible.CURSED_RESEARCH, CAItems.DICTATION_CHAPTER);
        ...
        addItemsToTag(MINECRAFT_MUSIC_DISCS, CAItems.RECORD_ISHARMLA, CAItems.RECORD_DEEPNESS, CAItems.RECORD_UNDERTIDES, CAItems.RECORD_PATH_AHEAD, CAItems.RECORD_ENDOSPORE, CAItems.RECORD_WHISPER, CAItems.BLOODY_RECORD, CAItems.SCORE, CAItems.RECORD_OCEANWISH, CAItems.RECORD_UNDERDAWN, CAItems.RECORD_MARE_NATUS);
