...
public class GuideAbyssalEntity extends SeaMonster {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(DATA_LAYLIMIT, 64);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(12, new NearestAttackableTargetGoal<>(this, ZombifiedPiglin.class, true, false));this.goalSelector.addGoal(15, new RandomStrollGoal(this, 1));
	...
	public SoundEvent getHurtSound(DamageSource source) {
		return CASounds.BRANDGUIDER_HIT.get();
	}

	@Override
	public SoundEvent getDeathSound() {
		return CASounds.BRANDGUIDER_DEATH.get();
	}
	...
	public static void registerSpawnPlacements(RegisterSpawnPlacementsEvent event) {
		event.register(CAEntities.GUIDE_ABYSSAL.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
