...
public class PregnantFishEntity extends SeaMonster implements RangedAttackMob {
	...
	public PregnantFishEntity(Level world) {
	...
	protected void registerGoals() {
		super.registerGoals();this.goalSelector.addGoal(14, new RandomStrollGoal(this, 0.6));
		...
		this.goalSelector.addGoal(8, new MountVehicleGoal(this, OceanizedPolarBearEntity.class, OceanizedHorseEntity.class));
	...
	public class RangedAttackGoal extends Goal {
		...
		public void stop() {
			...
			this.seeTime = 0;
			this.attackTime = -1;
			((PregnantFishEntity) rangedAttackMob).entityData.set(DATA_SHOOT, false);
		}
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((PregnantFishEntity) rangedAttackMob).entityData.set(DATA_SHOOT, true);
	...
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(SoundEvents.EMPTY, 0.15f, 1);
	}
	...
	public static void registerSpawnPlacements(RegisterSpawnPlacementsEvent event) {
		event.register(CAEntities.PREGNANT_FISH.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
