...
public class UmbrellaAbyssalEntity extends SeaMonster {
	...
	public static final EntityDataAccessor<String> DATA_ANIMATION = SynchedEntityData.defineId(UmbrellaAbyssalEntity.class, EntityDataSerializers.STRING);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new MoveToTargetGoal(this, 0.4, false));
		...
		this.targetSelector.addGoal(12, new NearestAttackableTargetGoal<>(this, ZombifiedPiglin.class, false, false));this.goalSelector.addGoal(14, new RandomStrollGoal(this, 0.4));
	...
	public static void registerSpawnPlacements(RegisterSpawnPlacementsEvent event) {
		event.register(CAEntities.UMBRELLA_ABYSSAL.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> {
			int x = pos.getX();
			int y = pos.getY();
			int z = pos.getZ();
