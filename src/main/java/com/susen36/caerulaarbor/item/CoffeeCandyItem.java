...
public class CoffeeCandyItem extends CollectibleItem.CustomCollectibleItem {
	public CoffeeCandyItem() {
		super(new Item.Properties().stacksTo(64).rarity(Rarity.UNCOMMON).food((new FoodProperties.Builder()).nutrition(2).saturationModifier(1f).build()), true, 30, CollectibleTiers.NORMAL, 0, 1, 0,
