...
public class MeatCanItem extends CollectibleItem.CustomCollectibleItem {
	public MeatCanItem() {
		super(new Item.Properties().stacksTo(64).rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(14).saturationModifier(0.25f).build()), 40, false, CollectibleTiers.NORMAL, new CollectibleItem.Levels(0, 1, 0),
