...
public class IsharmlaCurseMobEffect extends MobEffect {
    ...
    public boolean applyEffectTick(LivingEntity entity, int amplifier) {
        ...
        double d;
        double t;
        d = (entity instanceof LivingEntity livEnt ? livEnt.getMaxHealth() : -1) * 0.25 * ((double) amplifier + 1);
        entity.hurt(CADamageTypes.source(world, CADamageTypes.ISHARMLA_CURSED), (float) d);
